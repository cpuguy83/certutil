...
// in the arguments.
func GenerateCA(certFile, keyFile string, rsabits int) error {
...
func GenerateCert(hosts []string, certFile, keyFile, caFile, caKeyFile string, rsabits int) error {
	template, err := newCertificateTemplate()
	if err != nil {
		return err
	}
